...
urlpatterns = [
    ...
    url(r'^^(?P<owner_name>[\w-]+)/edit_repository/(?P<repository_id>\d+)/$', views.edit_repository_byid, name='edit_repository_byid'),
    url(r'^^(?P<owner_name>[\w-]+)/repository/delete/(?P<repository_id>\d+)/$', views.delete_repository, name='delete_repository'),
    url(r'^^(?P<owner_name>[\w-]+)/repository/edit/(?P<repository_id>\d+)/$', views.edit_repository, name='edit_repository'),
