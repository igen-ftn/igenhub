...
urlpatterns = [
    ...
    url(r'^(?P<owner_name>[\w-]+)/(?P<repo_name>[\w-]+)/tasks/$', views.task, name='task'),
    url(r'^(?P<owner_name>[\w-]+)/(?P<repo_name>[\w-]+)/task-form/$', views.task_form, name='task-form'),
    url(r'^(?P<owner_name>[\w-]+)/(?P<repo_name>[\w-]+)/task-page/(?P<task_id>\d+)/$', views.task_page, name='task-page'),
    url(r'^(?P<owner_name>[\w-]+)/(?P<repo_name>[\w-]+)/task-remove/(?P<task_id>\d+)/$', views.remove_task, name='remove-task'),
    url(r'^(?P<owner_name>[\w-]+)/(?P<repo_name>[\w-]+)/task-edit/(?P<task_id>\d+)/$', views.edit_task, name='edit-task'),
    url(r'^(?P<owner_name>[\w-]+)/(?P<repo_name>[\w-]+)/tasks/search/$', views.search_task, name='task-search'),
